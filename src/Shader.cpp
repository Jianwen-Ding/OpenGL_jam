...
void Shader::setVec2List(const std::string &name, int length, std::vector<glm::vec2> value) const{
    glUniform2fv(glGetUniformLocation(ID, name.c_str()), length, &value[0].x);
}